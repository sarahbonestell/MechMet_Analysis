...
neper -T -n from_morpho -domain "cube(0.990,0.990,0.550)" -morpho "tesr:file("${TESR_FN}.tesr")" -morphooptiobjective "pts(region=surf,res=7)" -morphooptistop itermax=10000 -reg 1 -o $TESS_FN
